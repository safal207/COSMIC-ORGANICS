"""Render a portable 9-decimal scientific summary for W7 confirmation."""
...
def render(report: dict) -> dict:
    body = _q(
        {
            "schema": "cosmic-organics/w7-confirmation-summary-0.1",
...
def main() -> None:
    ...
    args.output.write_text(
        json.dumps(render(report), indent=2, sort_keys=True) + "\n",
        encoding="utf-8",
    )
